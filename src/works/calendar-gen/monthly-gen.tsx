...
function renderPage(img: CalendarImage, idx: number) {
  ...
  return <div>
    ...
    <div style={{ position: 'absolute', bottom: 0, width: '100%', height: '20%', background: 'rgba(255,255,255,0.9)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, fontWeight: 600 }}>
